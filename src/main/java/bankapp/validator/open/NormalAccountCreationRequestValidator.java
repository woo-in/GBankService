...
@Slf4j
@Component
public class NormalAccountCreationRequestValidator implements Validator {
    ...
    public boolean supports(Class<?> clazz) {
        return NormalAccountCreationRequest.class.isAssignableFrom(clazz);
    }
    ...
    public void validate(Object target, Errors errors) {
        ...
        NormalAccountCreationRequest request = (NormalAccountCreationRequest) target;
